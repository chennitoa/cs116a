...
void ofApp::setup()
{
	...
	// Lights
	PointLight* l1 = new PointLight(glm::vec3(4.0f, 6.0f, 0.0f), 20.0f);
	PointLight* l2 = new PointLight(glm::vec3(-4.0f, 6.0f, 0.0f), 20.0f);
	PointLight* l3 = new PointLight(glm::vec3(4.0f, 0.5f, 4.0f), 20.0f);

	AreaLight* a1 = new AreaLight(glm::vec3(-1.0f, 6.0f, 0.0f), 50.0f, 5.0f, 5.0f, 5, 5, 1);
